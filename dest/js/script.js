...
var StringCounter = function () {
  function StringCounter(el, maxLength) {
    _classCallCheck(this, StringCounter);
...
var Sample = function () {
  ...
  _createClass(Sample, [{
    key: "load",
    value: function load(url, params) {
      var obj = {};
...
var Test = function () {
  ...
  _createClass(Test, [{
    key: "add",
    value: function add(target, blurX, blurY) {
...
},{"./mod/AnimationMod":6,"./mod/Counter":7,"./mod/Global":8,"./mod/Sample":9,"./mod/Test":10,"classlist-polyfill":1,"es5-shim":2,"raf":5}]},{},[11]);
